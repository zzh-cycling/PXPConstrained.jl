...
@btime rdm_PXP(BitStr{26, Int}, collect(1:13), ones(271443)) # 116ms
@btime rdm_PXP(BitStr{28, Int}, collect(1:14), ones(710647)) # 459ms
@btime rdm_PXP(30, collect(1:15), ones(1860498)) # 1.9s

@btime iso_total2K(24,0) # 357ms
@btime rdm_PXP_K(BitStr{24, Int}, collect(1:12), ones(4341),0) # 42ms
@btime rdm_PXP_K(BitStr{26, Int}, collect(1:13), ones(10462),0) #116.2
@btime rdm_PXP_K(BitStr{28, Int}, collect(1:14), ones(25415),0) # 582ms
